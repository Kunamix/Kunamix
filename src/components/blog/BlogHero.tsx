  ...
  return (
    <section className="pt-[120px] pb-[40px] px-4 xs:px-5 sm:px-6 md:px-5 max-w-[1280px] mx-auto md:pt-[140px]">
      <div className="flex flex-col items-center text-center max-w-3xl mx-auto min-w-0">
        ...
        >
          Insights, guides, and tutorials <br className="hidden sm:block" />
          on <em className="not-italic italic font-light text-primary">MVP development</em>.
        </motion.h1>
        ...
        >
          Deep dives into modern tech stacks, startup strategies, and actionable advice from our engineering team.
        </motion.p>
      </div>
    </section>
  );
