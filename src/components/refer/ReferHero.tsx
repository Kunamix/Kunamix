  ...
  return (
    <section className="pt-[120px] pb-[72px] px-4 xs:px-5 sm:px-6 md:px-5 max-w-[1280px] mx-auto md:pt-[140px]">
      <div className="flex flex-col items-center text-center max-w-3xl mx-auto min-w-0">
        ...
        >
          Refer a client, <br className="hidden sm:block" />
          earn <em className="not-italic italic font-light text-primary">up to 20%</em> commission.
        </motion.h1>
        ...
        >
          Know someone who needs exceptional digital solutions? Connect them with us and earn generous rewards for every successful project delivered.
        </motion.p>
      </div>
    </section>
  );
